...
SUM(SALARY) AS `SUM_SALARY`, ROUND(AVG(SALARY), 2) AS `AVG_SALARY` 
FROM hr.employees;
...
SELECT FIRST_NAME, LAST_NAME, DATEDIFF(CURRENT_DATE, HIRE_DATE) AS `WORKING_TIME` FROM hr.employees;